      ...
      <main className={cn(
        ...
        <div
          className={cn(
            ...
            // Si la sidebar est repliée, on laisse le container s'étendre
            // sur toute la largeur disponible. Sinon on plafonne à 7xl
            // (1280 px) centré pour préserver la lisibilité.
