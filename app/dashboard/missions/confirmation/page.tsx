...
export default function MissionsConfirmationPage() {
  const missions = getMissionsByStatus("pending_confirmation");
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-text-light">
              {missions.length} mission{missions.length > 1 ? "s" : ""} en attente de confirmation client
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-orange-700">
            Vous avez accepté ces missions. Le propriétaire doit maintenant confirmer la réservation.
          </p>
        </div>
      </motion.div>
