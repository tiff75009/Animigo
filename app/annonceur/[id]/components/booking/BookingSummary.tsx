    ...
    return (
      ...
      >
        <div className="text-center py-6">
          ...
          >
            <Sparkles className="w-5 h-5" style={{ color: "#9c9484" }} />
          </div>
          <p className="text-[14px] font-semibold text-[#1f1f1d] tracking-[-0.01em]">
  ...
  if (showPartialState) {
    return (
      ...
      >
        ...
        <div className="pb-4 mb-4" style={{ borderBottom: "1px solid #f1ede3" }}>
          <div className="text-[10px] font-medium uppercase tracking-[0.1em] text-[#9c9484] mb-1">
            Formule sélectionnée
          </div>
          <p className="text-[14px] font-semibold text-[#1f1f1d] tracking-[-0.01em] flex items-center gap-2">
      ...
      <div className={cn("p-5 space-y-4", compact && "p-4 space-y-3")}>
        ...
        {animalCount > 1 && (
          <div
            ...
            style={{ borderRadius: 12, background: "#fcfaf4", border: "1px solid #f1ede3" }}
          >
            <Users className="w-3.5 h-3.5" style={{ color: "#6d6d68" }} />
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            <Package className="w-3.5 h-3.5" style={{ color: "#1f3a33" }} />
            <span className="text-[10px] font-medium uppercase tracking-[0.1em]" style={{ color: "#9c9484" }}>
              Formule
            </span>
          </div>
          <p className="text-[14px] font-semibold text-[#1f3a33] tracking-[-0.01em] flex items-center gap-2">
            <span>{service.categoryIcon}</span>
            {variant.name}
          </p>
          {isCollectiveFormule && (
            <span
              className="inline-flex items-center mt-1.5 px-1.5 py-0.5 rounded-full text-[10px] font-medium"
              style={{ border: "1px solid #cfdbd3", color: "#2f4a3f", background: "#fff" }}
            >
              Séance collective
            </span>
        ...
        {/* Total TTC */}
        <div className="pt-3" style={{ borderTop: "1px solid #1f3a33" }}>
          <div className="flex justify-between items-baseline">
            <span className="text-[13px] font-semibold text-[#1f1f1d] tracking-[-0.01em]">Total à payer</span>
            <span className="text-[18px] font-bold text-[#1f3a33] tracking-[-0.01em]">
              {(() => {
                let subtotalHT = 0;
                if (isCollectiveFormule && variant) {
                  subtotalHT = getCollectiveOrMultiSessionTotal(variant, actualSlotCount, animalCount);
      ...
      {!compact && (
        ...
        >
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 text-[11px] font-medium transition-colors hover:text-[#1f1f1d]"
            style={{ color: "#6d6d68" }}
          >
