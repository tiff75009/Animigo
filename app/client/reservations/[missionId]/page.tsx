...
export default function ReservationDetailPage() {
  ...
  return (
    <div className="space-y-5 max-w-3xl mx-auto pb-8">
      ...
      {/* Bloc remboursement (missions annulées) */}
      {(mission.status === "cancelled" || mission.status === "refused") &&
        (mission.paymentStatus === "refunded" || (mission.refundAmount != null && mission.refundAmount > 0) || mission.paymentStatus === "paid") && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
