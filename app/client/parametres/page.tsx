...
let stripePromiseSettings: Promise<any> | null = null;
...
// Formulaire d'ajout de carte (utilise Stripe Elements)
...
// Tab Paiement
function PaiementTab({ token }: { token: string | null }) {
  ...
  // Client secret dispo pour le formulaire d'ajout
  const clientSecret = setupIntentStatus?.clientSecret;

  // Appearance Stripe Elements
