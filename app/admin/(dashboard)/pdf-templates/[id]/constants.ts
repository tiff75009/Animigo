...
export type DocumentType = "invoice" | "client_receipt" | "refund_receipt" | "receipt";
...
// Balises spécifiques au bon de remboursement
export const REFUND_RECEIPT_FIELDS: FieldDef[] = [
  // Identification
  { key: "refundNumber", label: "N° Remboursement", example: "REM-2026-0042", documentTypes: ["refund_receipt"] },
  { key: "bookingNumber", label: "N° Réservation d'origine", example: "RES-2026-0042", documentTypes: ["refund_receipt"] },
  { key: "refundStatus", label: "Statut remboursement", example: "TRAITÉ", documentTypes: ["refund_receipt"] },
  { key: "refundDate", label: "Date + heure du remboursement", example: "12/03/2026 à 14:32", documentTypes: ["refund_receipt"] },
  { key: "cancellationCount", label: "Niveau d'annulation", example: "2ème annulation", documentTypes: ["refund_receipt"] },
  // Détails financiers
  { key: "originalAmount", label: "Montant payé initialement", example: "90,00 €", documentTypes: ["refund_receipt"] },
  { key: "refundAmount", label: "Montant remboursé (net)", example: "72,00 €", documentTypes: ["refund_receipt"] },
  { key: "platformFeeRetained", label: "Frais de service retenus", example: "13,50 €", documentTypes: ["refund_receipt"] },
  { key: "stripeFeeRetained", label: "Frais bancaires retenus", example: "2,70 €", documentTypes: ["refund_receipt"] },
  { key: "announcerRetained", label: "Pénalité d'annulation", example: "0,00 €", documentTypes: ["refund_receipt"] },
  // Carte bancaire (CB d'origine sur laquelle le remboursement est effectué)
  { key: "cardLast4", label: "4 derniers chiffres CB", example: "•••• 4242", documentTypes: ["refund_receipt"] },
  { key: "cardBrand", label: "Marque carte", example: "Visa", documentTypes: ["refund_receipt"] },
  // IDs Stripe pour traçabilité
  { key: "transactionId", label: "ID transaction paiement (Stripe)", example: "pi_3OqXyz1abc...", documentTypes: ["refund_receipt"] },
  { key: "refundStripeId", label: "ID remboursement (Stripe)", example: "re_3OqXyz1abc...", documentTypes: ["refund_receipt"] },
  { key: "refundDelay", label: "Délai estimé crédit bancaire", example: "3 à 5 jours ouvrés", documentTypes: ["refund_receipt"] },
  // Service
  { key: "bookingDate", label: "Date prestation annulée", example: "15/03/2026", documentTypes: ["refund_receipt"] },
  // Prestataire
  { key: "serviceProvider", label: "Nom prestataire", example: "Marie Martin", documentTypes: ["refund_receipt"] },
  { key: "providerStatus", label: "Statut prestataire", example: "Micro-entrepreneur", documentTypes: ["refund_receipt"] },
  { key: "providerAddress", label: "Adresse prestataire", example: "12 rue des Lilas, 75015 Paris", documentTypes: ["refund_receipt"] },
  // Plateforme (mêmes que client_receipt mais redéfinis pour l'autocomplete)
  { key: "platformName", label: "Nom plateforme", example: "Animigo", documentTypes: ["refund_receipt"] },
  { key: "platformLegalName", label: "Raison sociale plateforme", example: "Animigo SAS", documentTypes: ["refund_receipt"] },
  { key: "platformAddress", label: "Adresse plateforme", example: "10 rue de la Paix, 75002 Paris", documentTypes: ["refund_receipt"] },
  { key: "platformSiret", label: "SIRET plateforme", example: "SIRET : 987 654 321 00023", documentTypes: ["refund_receipt"] },
  { key: "platformCapital", label: "Capital social plateforme", example: "Capital social : 10 000 €", documentTypes: ["refund_receipt"] },
  { key: "platformContact", label: "Contact plateforme", example: "support@animigo.fr", documentTypes: ["refund_receipt"] },
  // Motif & mentions
  { key: "refundReason", label: "Motif du remboursement", example: "1ère annulation : remboursement intégral hors frais", documentTypes: ["refund_receipt"] },
  { key: "refundMention", label: "Délai bancaire", example: "Le remboursement apparaîtra sous 3 à 5 jours ouvrés", documentTypes: ["refund_receipt"] },
  { key: "feesMention", label: "Mention frais retenus", example: "Conformément aux CGV, les frais sont conservés...", documentTypes: ["refund_receipt"] },
  { key: "legalMention", label: "Mention légale", example: "Document généré automatiquement par Animigo", documentTypes: ["refund_receipt"] },
  { key: "thankYouMessage", label: "Message de fin", example: "Merci pour votre confiance", documentTypes: ["refund_receipt"] },
];
...
/**
 * Template par défaut pour bon de remboursement client (palette ambre/rouge).
 * Pré-rempli avec :
 *  - Header "BON DE REMBOURSEMENT" + n° + date + badge "TRAITÉ"
 *  - Bloc client (destinataire)
 *  - Bloc service annulé + prestataire
 *  - Tableau récap : montant initial, frais retenus, pénalité, net remboursé
 *  - Motif d'annulation + délai bancaire
 *  - Mentions légales (CGV, frais conservés)
 *  - Footer Animigo
 */
export function getDefaultRefundReceiptTemplate() {
  return {
    basePdf: { width: 210, height: 297, padding: [15, 15, 15, 15] },
    schemas: [[
      // ─── HEADER ───
      ...
      // ─── DESTINATAIRE (CLIENT) ───
      {
        name: "labelClient",
        type: "text",
        content: "REMBOURSEMENT EFFECTUÉ À",
        position: { x: 0, y: 30 },
        width: 80,
        height: 4,
        fontSize: 8,
      ...
      },
      {
        name: "serviceName",
        type: "text",
        content: "Garde de chien — Formule weekend",
        position: { x: 35, y: 67 },
        width: 145,
        height: 5,
        fontSize: 9,
      ...
      },
      {
        name: "serviceProvider",
        type: "text",
        content: "Marie Martin (Micro-entrepreneur)",
        position: { x: 35, y: 79 },
        width: 145,
        height: 5,
        fontSize: 9,
      ...
      // ─── DÉTAIL DU REMBOURSEMENT ───
      {
        name: "sectionRefund",
        type: "text",
        content: "DÉTAIL DU REMBOURSEMENT",
        position: { x: 0, y: 95 },
        width: 180,
        height: 5,
        fontSize: 9,
      ...
      {
        name: "labelRefundDate",
        type: "text",
        content: "Date du remboursement :",
        position: { x: 0, y: 102 },
        width: 70,
        height: 5,
        fontSize: 9,
      ...
      {
        name: "labelCancellationCount",
        type: "text",
        content: "Niveau d'annulation :",
        position: { x: 0, y: 108 },
        width: 70,
        height: 5,
        fontSize: 9,
      ...
      },
      {
        name: "labelCardLast4",
        type: "text",
        content: "Carte de remboursement :",
        position: { x: 0, y: 114 },
        width: 70,
        height: 5,
        fontSize: 9,
      ...
      {
        name: "labelRefundStripeId",
        type: "text",
        content: "Réf. remboursement Stripe :",
        position: { x: 0, y: 125 },
        width: 70,
        height: 5,
        fontSize: 8,
      ...
      {
        name: "labelRefundDelay",
        type: "text",
        content: "Délai estimé de crédit :",
        position: { x: 0, y: 130 },
        width: 70,
        height: 5,
        fontSize: 8,
      ...
      // ─── TABLEAU RÉCAPITULATIF (lignes manuelles) ───
      {
        name: "labelOriginalAmount",
        type: "text",
        content: "Montant payé initialement",
        position: { x: 0, y: 142 },
        width: 110,
        height: 5,
        fontSize: 9,
      ...
      {
        name: "labelPlatformFeeRetained",
        type: "text",
        content: "Frais de service retenus",
        position: { x: 0, y: 148 },
        width: 110,
        height: 5,
        fontSize: 9,
      ...
      {
        name: "labelStripeFeeRetained",
        type: "text",
        content: "Frais bancaires retenus",
        position: { x: 0, y: 154 },
        width: 110,
        height: 5,
        fontSize: 9,
      ...
      {
        name: "stripeFeeRetained",
        type: "text",
        content: "− 2,70 €",
        position: { x: 130, y: 154 },
        width: 50,
        height: 5,
        fontSize: 9,
        fontColor: "#dc2626",
      ...
      {
        name: "labelAnnouncerRetained",
        type: "text",
        content: "Pénalité d'annulation (annonceur)",
        position: { x: 0, y: 160 },
        width: 110,
        height: 5,
        fontSize: 9,
      ...
      // ─── MONTANT NET REMBOURSÉ (gros, vert) ───
      {
        name: "labelRefundAmount",
        type: "text",
        content: "MONTANT REMBOURSÉ",
        position: { x: 110, y: 172 },
        width: 70,
        height: 5,
        fontSize: 9,
        fontColor: "#9c9484",
      ...
      // ─── MOTIF ───
      {
        name: "labelRefundReason",
        type: "text",
        content: "MOTIF DU REMBOURSEMENT",
        position: { x: 0, y: 196 },
        width: 180,
        height: 5,
        fontSize: 8,
      ...
      },
      {
        name: "refundReason",
        type: "text",
        content: "1ère annulation : remboursement intégral hors frais de service et Stripe",
        position: { x: 0, y: 202 },
        width: 180,
        height: 6,
        fontSize: 9,
      ...
      // ─── MENTIONS LÉGALES ───
      {
        name: "refundMention",
        type: "text",
        content: "Le remboursement apparaîtra sur votre carte bancaire d'origine sous 3 à 5 jours ouvrés selon votre banque.",
        position: { x: 0, y: 215 },
        width: 180,
        height: 5,
        fontSize: 7,
      ...
      },
      {
        name: "feesMention",
        type: "text",
        content: "Conformément aux Conditions Générales de Vente, les frais de service Animigo et les frais de gestion bancaire sont conservés par la plateforme dans tous les cas.",
        position: { x: 0, y: 221 },
        width: 180,
        height: 8,
        fontSize: 7,
      ...
      },
      {
        name: "legalMention",
        type: "text",
        content: "Document généré automatiquement par Animigo. Pour toute question, contactez notre support.",
        position: { x: 0, y: 230 },
        width: 180,
        height: 5,
        fontSize: 7,
