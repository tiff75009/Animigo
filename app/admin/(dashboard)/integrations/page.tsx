            ...
            {integration.webhookInfo && (() => {
              ...
              <div className="p-6 border-t border-slate-800 bg-slate-800/30">
                <div className="flex items-center gap-2 mb-4">
                  <Webhook className={`w-5 h-5 text-${accentColor}-400`} />
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-slate-300 mb-2">
                    URL du Webhook à configurer dans {serviceName}
                  </label>
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-slate-300 mb-2">
                    Événements gérés par le webhook {serviceName}
                  </label>
                    ...
                    {integration.webhookInfo!.events.map((evt) => (
                      ...
                      >
                        <div className="flex-shrink-0 mt-0.5">
                          <div className={`w-2 h-2 bg-${accentColor}-400 rounded-full`} />
                        </div>
                        <div>
                          <code className={`text-xs text-${accentColor}-300 font-mono`}>
                            {evt.event}
                          </code>
