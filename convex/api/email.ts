...
<tr><td align="center" style="padding:32px 16px;">
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background-color:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #ece9e1;">
    ...
    <!-- ━━━ Mentions légales (escrow + intermédiation + Stripe) ━━━ -->
    <tr>
      <td style="padding:16px 32px 8px 32px;border-top:1px solid #f1ede3;">
        ...
        <!-- Bloc escrow (compte séquestre Stripe Connect) -->
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:8px;">
          <tr>
            <td style="padding:10px 14px;background-color:#f5f9f6;border-left:3px solid #1f3a33;border-radius:6px;">
              <p style="margin:0;color:#1f3a33;font-size:11.5px;line-height:1.5;">
                <strong>🔒 Fonds sécurisés :</strong> votre paiement est conservé sur le compte séquestre {{siteName}} jusqu'à confirmation de la réalisation du service par vos soins, puis reversé au prestataire conformément à nos CGV.
              </p>
            </td>
          </tr>
        </table>

        <!-- Intermédiation + facture -->
        <p style="margin:8px 0;color:#9c9484;font-size:11px;line-height:1.6;">
          {{siteName}} agit en tant que <strong>plateforme de mise en relation</strong> entre les particuliers et les prestataires de services animaliers. Le présent document est un reçu de paiement et <strong>ne constitue pas une facture commerciale</strong>.
        </p>
        <p style="margin:8px 0;color:#9c9484;font-size:11px;line-height:1.6;">
          La facture comptable détaillée (avec TVA, mentions légales du prestataire) sera émise par votre prestataire une fois la prestation terminée.
        </p>
        <p style="margin:8px 0 0 0;color:#9c9484;font-size:11px;line-height:1.6;">
          Paiement sécurisé traité par <strong>Stripe Payments Europe Ltd</strong>, prestataire de services de paiement agréé.
        </p>
      </td>
    </tr>
